...
const BSC_TOKEN_WEBHOOK = async (req, res, next) => {
  try {
    ...
    for (const webhookData of webhookDataArray) {
      ...
      try {
        ...
        const web3 = new Web3(
          new Web3.providers.HttpProvider(QUICKNODE_URL.USDC_BSC)
        );
        ...
        const coin1 = TEST_COINS.USDC_BSC;
        const coin2 = TEST_COINS.USDT_BSC;
...
module.exports = { BSC_TOKEN_WEBHOOK };
